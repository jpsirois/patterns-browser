...
$.ajaxPrefilter( function( options, originalOptions, jqXHR ) {
  ...
  if ( value ){
    ...
    // FIXME Quickly ugly fix for this project
    // if ( options.dataType.indexOf( 'json' ) === 0 ) value = JSON.parse( value );
    if ( options.dataTypes[0].indexOf( '*' ) === 0 ) value = JSON.parse( value );
    ...
    options.success = function( data ) {
      ...
      if ( this.dataTypes[1].indexOf( 'json' ) === 0 ) strdata = JSON.stringify( data );
